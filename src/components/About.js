          ...
          <div className="text-black  md:ml-0 md:pt-0 md:leading-9 rounded-2xl xl:text-start md:text-start lg:text-start sm:text-start p-8 sm:p-5 md:w-1/2">
           ...
           <p className="mb-3 dark:text-gray-100 ">I am a passionate <span className="font-bold">full-stack web developer </span> who thrives on continuous exploration 
            ...
            <p className="mb-3 dark:text-gray-100 ">Coding   holds a special place in my heart, and I find joy in the process of creating impactful
             ...
             <p className="dark:text-gray-100 "> I'm open to exciting <span className="font-bold">job  </span> opportunities that provide a platform for me to contribute, learn,
