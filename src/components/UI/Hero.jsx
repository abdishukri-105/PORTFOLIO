        ...
        <div className="md:flex items-center justify-between sm:flex-col md:flex-row">
          ...
          <div className="w-full md:basis-2/3">
            ...
            >
              ...
              I'm a seasoned, certified cloud and software engineer, wielding
              the power of the cloud to craft high-performance web applications.
              My code is clean, secure, and optimized to dominate search
              engines.
            </p>
            ...
            <div className="flex items-center gap-9 mt-6">
              ...
              <span>
                <a
                  href="https://www.instagram.com/__abdishukri_/"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="basis-1/3 mt-10 sm:mt-0">
            <figure className="flex  items-center justify-center">
              <img
                ...
                alt="image of Abdishukri Mohamed"
                src={shukri}
              ></img>
            </figure>
          </div>
